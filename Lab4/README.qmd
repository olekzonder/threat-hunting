...
Таким образом, были изучены возможности работы с платформой threat intelligence OpenCTI.Я смог кстати в итоге поднять базу на своей стороне, надо значит будет разобраться полноценно во всём и мысли синхронизировать